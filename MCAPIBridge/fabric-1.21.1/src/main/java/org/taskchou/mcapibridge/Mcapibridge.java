...
public class Mcapibridge implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.BLOCK, Identifier.of("mcapibridge", "screen"), SCREEN_BLOCK);
        Item screenItem = Registry.register(Registries.ITEM, Identifier.of("mcapibridge", "screen"), new ScreenBlockItem(SCREEN_BLOCK, new Item.Settings()));

        Registry.register(Registries.BLOCK, Identifier.of("mcapibridge", "io"), IO_BLOCK);
        Item ioItem=Registry.register(Registries.ITEM, Identifier.of("mcapibridge", "io"), new IOBlockItem(IO_BLOCK, new Item.Settings()));
