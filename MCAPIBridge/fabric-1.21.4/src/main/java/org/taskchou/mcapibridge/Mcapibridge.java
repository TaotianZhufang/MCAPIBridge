...
public class Mcapibridge implements ModInitializer {
    ...
    public static final Identifier CLICK_PACKET_ID = Identifier.of("mcapibridge", "click_event");
    ...
    public static final Identifier SCREEN_ID = Identifier.of("mcapibridge", "screen");
    public static final Identifier IO_ID = Identifier.of("mcapibridge", "io");

    public static final RegistryKey<Block> SCREEN_BLOCK_KEY = RegistryKey.of(RegistryKeys.BLOCK, SCREEN_ID);
    public static final RegistryKey<Item> SCREEN_ITEM_KEY = RegistryKey.of(RegistryKeys.ITEM, SCREEN_ID);

    public static final RegistryKey<Block> IO_BLOCK_KEY = RegistryKey.of(RegistryKeys.BLOCK, IO_ID);
    public static final RegistryKey<Item> IO_ITEM_KEY = RegistryKey.of(RegistryKeys.ITEM, IO_ID);

    public static final Block SCREEN_BLOCK = new ScreenBlock(
            AbstractBlock.Settings.create()
                    .registryKey(SCREEN_BLOCK_KEY)
                    .strength(1.0f)
                    .luminance(s -> 15)
    );

    public static final Block IO_BLOCK = new IOBlock(
            AbstractBlock.Settings.create()
                    .registryKey(IO_BLOCK_KEY)
                    .strength(1.0f)
    );

    public static Item SCREEN_ITEM;
    public static Item IO_ITEM;
    ...
    public record AudioDataPayload(String action, String id, int sampleRate, byte[] data) implements CustomPayload {
        public static final CustomPayload.Id<AudioDataPayload> ID =
                new CustomPayload.Id<>(Identifier.of("mcapibridge", "audio"));
    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.BLOCK, SCREEN_BLOCK_KEY, SCREEN_BLOCK);

        SCREEN_ITEM = new ScreenBlockItem(SCREEN_BLOCK, new Item.Settings().registryKey(SCREEN_ITEM_KEY));
        Registry.register(Registries.ITEM, SCREEN_ITEM_KEY, SCREEN_ITEM);

        Registry.register(Registries.BLOCK, IO_BLOCK_KEY, IO_BLOCK);

        IO_ITEM = new IOBlockItem(IO_BLOCK, new Item.Settings().registryKey(IO_ITEM_KEY));
        Registry.register(Registries.ITEM, IO_ITEM_KEY, IO_ITEM);

        SCREEN_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.of("mcapibridge", "screen_block_entity"),
        ...
        System.out.println("Registered Screen Item: " + Registries.ITEM.getId(SCREEN_ITEM));
        System.out.println("Registered Screen Block: " + Registries.BLOCK.getId(SCREEN_BLOCK));
    ...
    private static class BridgeClientHandler extends Thread {
        ...
        private String setBlock(String[] args) {
            ...
            mcServer.execute(() -> {
                ...
                Identifier id = Identifier.of(finalId);
        ...
        private String spawnEntity(String[] args) {
            ...
            return CompletableFuture.supplyAsync(() -> {
                ...
                Identifier id = Identifier.of(finalName);
        ...
        private String spawnParticle(String[] args) {
            ...
            mcServer.execute(() -> {
                ...
                ParticleType<?> t = Registries.PARTICLE_TYPE.get(Identifier.of(fName));
            ...
            mcServer.execute(() -> {
                ...
                if (p != null) {
                    if (amount > p.getMaxHealth()) {
                        p.getAttributeInstance(EntityAttributes.MAX_HEALTH).setBaseValue(amount);
                    }
                    p.setHealth(amount);
                }
            });
        ...
        private String giveItem(String[] args) {
            ...
            mcServer.execute(() -> {
                ServerPlayerEntity p = findPlayer(target);
                if (p != null) {
                    ItemStack stack = new ItemStack(Registries.ITEM.get(Identifier.of(itemID)), count);
        ...
        private String giveEffect(String[] args) {
            ...
            mcServer.execute(() -> {
                ServerPlayerEntity p = findPlayer(target);
                if (p != null) {
                    Identifier id = Identifier.of(effectName);
        ...
        private String teleport(String[] args) {
            ...
            mcServer.execute(() -> {
                ...
                if (p != null) {
                    p.teleport(p.getServerWorld(), x, y, z, EnumSet.noneOf(PositionFlag.class) ,p.getYaw(), p.getPitch(),false);
                }
            });
            return null;
        }
        ...
        private String teleportEntity(String[] args) {
            ...
            mcServer.execute(() -> {
                ...
                if (e != null) {
                    ...
                    if (e instanceof ServerPlayerEntity) {
                        ((ServerPlayerEntity) e).teleport(destinationWorld, x, y, z, EnumSet.noneOf(PositionFlag.class),e.getYaw(), e.getPitch(),false);
                    } else {
