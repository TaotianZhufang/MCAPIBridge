...
public class IOBlockRenderer implements BlockEntityRenderer<IOBlockEntity> {
    ...
    private static final Identifier TEX_INPUT = new Identifier("mcapibridge", "textures/block/io_top_in_emissive.png");
    private static final Identifier TEX_OUTPUT = new Identifier("mcapibridge", "textures/block/io_top_out_emissive.png");
    ...
    public void render(IOBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        buffer.vertex(mat, 0, 0, 0).color(255,255,255,255).texture(0, 0)
                .overlay(overlay).light(0xF000F0).normal(0, 1, 0).next();
