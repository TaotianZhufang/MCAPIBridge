...
|------|------|------|--------|
| target | str | 玩家名 | 必填 |
| audio_id | str | 音频唯一标识符 | 必填 |
| pcm_data | bytes | 16位有符号整数 PCM 数据 | 必填 |
| sample_rate | int | 采样率 | 44100 |
...
### `set_position(target, audio_id, x, y, z)` (需通过 _send 调用)
