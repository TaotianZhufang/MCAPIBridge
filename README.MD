...
### 🖥️ Client-Side Rendering *(Coming Soon)*
*   **HUD Overlay**: Draw custom text, rectangles, and progress bars on the player's screen.
*   **3D World Drawing**: Render lines, boxes, and markers in the 3D world space.
